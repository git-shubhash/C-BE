...
router.get('/service-types/:departmentId', async (req, res) => {
    ...
    `;
        const result = await connection_1.default.query(query, [departmentId]);
        res.json(result.rows);
    }
    catch (error) {
...
router.get('/tests/:serviceTypeId', async (req, res) => {
    ...
    `;
        const result = await connection_1.default.query(query, [serviceTypeId]);
        res.json(result.rows);
    }
    catch (error) {
...
router.post('/departments', async (req, res) => {
    try {
      ...
      RETURNING *
    `;
        const result = await connection_1.default.query(query, [sub_department_name]);
...
router.post('/service-types', async (req, res) => {
    try {
      ...
      RETURNING *
    `;
        const result = await connection_1.default.query(query, [sub_department_id, service_type_name]);
        res.status(201).json(result.rows[0]);
    }
    catch (error) {
...
router.post('/tests', async (req, res) => {
    try {
      ...
      RETURNING *
    `;
        const result = await connection_1.default.query(query, [service_type_id, test_name, unit, normal_min, normal_max]);
        res.status(201).json(result.rows[0]);
    }
    catch (error) {
...
router.put('/departments/:id', async (req, res) => {
    try {
      ...
      RETURNING *
    `;
        const result = await connection_1.default.query(query, [sub_department_name, id]);
        if (result.rows.length === 0) {
...
router.put('/service-types/:id', async (req, res) => {
    try {
      ...
      RETURNING *
    `;
        const result = await connection_1.default.query(query, [service_type_name, id]);
        if (result.rows.length === 0) {
...
router.put('/tests/:id', async (req, res) => {
    try {
      ...
      RETURNING *
    `;
        const result = await connection_1.default.query(query, [test_name, unit, normal_min, normal_max, id]);
        if (result.rows.length === 0) {
