...
router.post('/', async (req, res) => {
  try {
    ...
    const prescriptionResult = await pool.query(prescriptionQuery, [prescription_id]);
    ...
    const result = await pool.query(insertQuery, [prescription_id, template_id, report_data]);
    ...
    await pool.query(updatePrescriptionQuery, [prescription_id]);
...
router.put('/:reportId', async (req, res) => {
  try {
    ...
    const result = await pool.query(query, [report_data, report_file_path || null, reportId]);
